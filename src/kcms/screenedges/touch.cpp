...
K_PLUGIN_FACTORY_WITH_JSON(KWinScreenEdgesConfigFactory, "deepin-kcm_kwintouchscreen.json", registerPlugin<KWin::KWinScreenEdgesConfig>(); registerPlugin<KWin::KWinTouchScreenData>();)
...
void KWinScreenEdgesConfig::monitorInit()
{
    ...
    const auto effects = KPackage::PackageLoader::self()->listPackages(QStringLiteral("KWin/Script"), QStringLiteral("kwin/builtin-effects/")) << KPackage::PackageLoader::self()->listPackages(QStringLiteral("KWin/Script"), QStringLiteral("deepin-kwin/effects/"));
