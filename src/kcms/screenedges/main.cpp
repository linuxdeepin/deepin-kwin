...
K_PLUGIN_FACTORY_WITH_JSON(KWinScreenEdgesConfigFactory, "deepin-kcm_kwinscreenedges.json", registerPlugin<KWin::KWinScreenEdgesConfig>(); registerPlugin<KWin::KWinScreenEdgeData>();)
