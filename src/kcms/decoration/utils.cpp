...
const QMap<KDecoration3::BorderSize, QString> s_borderSizeNames{
    {KDecoration3::BorderSize::None, i18n("No Borders")},
    {KDecoration3::BorderSize::NoSides, i18n("No Side Borders")},
    {KDecoration3::BorderSize::Tiny, i18n("Tiny")},
    {KDecoration3::BorderSize::Normal, i18n("Normal")},
    {KDecoration3::BorderSize::Large, i18n("Large")},
    {KDecoration3::BorderSize::VeryLarge, i18n("Very Large")},
    {KDecoration3::BorderSize::Huge, i18n("Huge")},
    {KDecoration3::BorderSize::VeryHuge, i18n("Very Huge")},
    {KDecoration3::BorderSize::Oversized, i18n("Oversized")}};
