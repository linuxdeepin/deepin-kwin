...
K_PLUGIN_FACTORY_WITH_JSON(KCMKWinDecorationFactory, "deepin-kwindecoration.json", registerPlugin<KCMKWinDecoration>();registerPlugin<KWinDecorationData>();)
...
{
    auto about = new KAboutData(QStringLiteral("deepin-kcm_kwindecoration"),
