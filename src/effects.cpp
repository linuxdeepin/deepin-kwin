...
WINDOW_HELPER(bool, isSplitBar, isSplitBar)
WINDOW_HELPER(bool, isWaterMark, isWaterMark)
WINDOW_HELPER(bool, isLockScreen, isLockScreen)
WINDOW_HELPER(bool, isSwitcherWin, isSwitcherWin)
...
KDecoration3::Decoration *EffectWindowImpl::decoration() const
{
