...
EFFECT_FALLBACK
        ...
        QStringLiteral("splithandler"),
        i18ndc("kwin_effects", "Name of a KWin Effect", "splithandler"),
        i18ndc("kwin_effects", "Comment describing the KWin Effect", "Window split window handler display"),
        QStringLiteral("Accessibility"),
        QString(),
        QUrl(),
        true,
        false,
#ifdef EFFECT_BUILTINS
        &createHelper<SplitHandlerEffect>,
        nullptr,
        nullptr
#endif
EFFECT_FALLBACK
